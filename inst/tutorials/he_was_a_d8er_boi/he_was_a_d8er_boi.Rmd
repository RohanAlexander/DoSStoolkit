...
- Use across() with summarise() to summarise multiple columns
- Use mutate_if()
- Use if_else() and na_if() within mutate()
...
post](https://www.alexcookson.com/post/most-successful-broadway-show-of-all-time/). Take a look at a subset of this data for the Winter Garden Theatre.
