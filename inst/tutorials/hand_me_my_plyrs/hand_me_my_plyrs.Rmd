...
Here is an example using base R's `summary()` without the pipe.
...
more about the data set provided by Alex Cookson in [the data
repository](https://github.com/tacookson/data) provided on GitHub, as well as this
corresponding [blog
...
Here, we are taking two sums, the sum of performances and the sum of previous, for each
distinct week.
...
- It is helpful to rename columns into something simpler.
...
column in the personalities data frame. This column already had a name, but if it didn't,
