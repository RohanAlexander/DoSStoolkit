...
```{r}
ggplot(x = mtcars, mapping = aes(mpg, disp)) + geom_point()
```
...
To start, we will load the data from GitHub, and take a subset.

```{r summarise-hidden-load, include = FALSE}
broadway <- read_csv(
...
```
```{r summarise-exercise-load, exercise = TRUE}
broadway <- read_csv(
  "https://raw.githubusercontent.com/tacookson/data/master/broadway-grosses/grosses.csv",
  guess_max = 10000)
