...
```{r loading-packages, echo = FALSE, fig.height = 3, fig.width = 4}
...
## Updating libraries with update.packages()
...
```{r updating-packages-img-1, echo = FALSE, fig.height = 3, fig.width = 4}
knitr::include_graphics("images/20_updating-libraries-1.PNG")
```

```{r updating-packages-img-2, echo = FALSE, fig.height = 3, fig.width = 4}
