...
As you might guess, this creates a header for our report with the title, author and date specified.
...
We simply nest the hyperlink syntax within the square brackets of the image syntax. For example,
